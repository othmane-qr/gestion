...
namespace gestion.Controllers
{
    public class EtudiantsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,CIN,Adresse")] Etudiant etudiant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,CIN,Adresse")] Etudiant etudiant)
        {
            if (id != etudiant.Id)
            {
                return NotFound();
